...
(function(root, factory) {
  ...
  describe('Query', function() {
    it('should create an instance of Query', function() {
      ...
      //var instane = new Flashmoov.Query();
      //expect(instance).to.be.a(Flashmoov.Query);
    });
    ...
    it('should have the property prj (base name: "prj")', function() {
      // uncomment below and update the code to test the property prj
      //var instane = new Flashmoov.Query();
      //expect(instance).to.be();
    });
