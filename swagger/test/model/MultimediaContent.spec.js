...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flashmoov.MultimediaContent();
  });
  ...
  describe('MultimediaContent', function() {
    it('should create an instance of MultimediaContent', function() {
      // uncomment below and update the code to test MultimediaContent
      //var instane = new Flashmoov.MultimediaContent();
      //expect(instance).to.be.a(Flashmoov.MultimediaContent);
    });
