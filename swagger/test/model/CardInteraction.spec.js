...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flashmoov.CardInteraction();
  });
  ...
  describe('CardInteraction', function() {
    it('should create an instance of CardInteraction', function() {
      // uncomment below and update the code to test CardInteraction
      //var instane = new Flashmoov.CardInteraction();
      //expect(instance).to.be.a(Flashmoov.CardInteraction);
    });
