...
(function(root, factory) {
  ...
  describe('Flash', function() {
    it('should create an instance of Flash', function() {
      // uncomment below and update the code to test Flash
      //var instane = new Flashmoov.Flash();
      //expect(instance).to.be.a(Flashmoov.Flash);
    });
